<template>
      <div>
        <v-toolbar style=" background-color: #004080;" flat fixed>
          <div class="white--text" style="font-size:2vw;">ElECTORAL COMMISSION --> HEADQUATERS</div>
         <v-spacer></v-spacer>
            <v-avatar size="68" >
                <img
          ...
          <v-layout  row justify-center>
            <v-flex sm12 md6>
              ...
              <v-card-actions>
                <div class="flex-grow-1"></div>
                <v-spacer></v-spacer>
                <v-btn small style=" background-color: #004080;" @click="login">Login</v-btn>
              </v-card-actions>
               <v-snackbar
              v-model="snackbar"
              :color="color"
  ...
  export default {
    ...
    data: function(){
      return{
        ...
        snackbar: false,
         color: 'general',
          errorMessages: 'Incorrect login credentials',
          showPassword: false
      }
